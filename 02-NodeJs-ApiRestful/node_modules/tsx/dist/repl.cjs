"use strict";var s=require("repl"),l=require("./package-b3a6a647.cjs"),u=require("./index-8582abce.cjs");require("url"),require("esbuild"),require("crypto"),require("fs"),require("path"),require("os");function c(e){return e&&typeof e=="object"&&"default"in e?e:{default:e}}var f=c(s);console.log(`Welcome to tsx v${l.version} (Node.js ${process.version}).
